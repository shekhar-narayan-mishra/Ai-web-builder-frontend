...
export function HomePage({ onProjectSelect, onGetStarted }: HomePageProps) {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Top Navigation Bar */}
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-gray-900 px-6 py-4">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold text-white tracking-tight">AI Website Builder</span>
          </div>
          <button
            onClick={onGetStarted}
            className="hidden sm:block px-5 py-2 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg text-sm font-medium text-white hover:scale-105 transition-transform"
          >
            Get Started
          </button>
        </div>
      ...
      <div className="pt-16">
        ...
        {/* Footer */}
        <div className="border-t border-gray-900 py-12 bg-[#0a0a0a]">
          <div className="container mx-auto px-6 text-center">
            <p className="text-gray-400 text-sm mb-4">
              made with ❤️ by shekhar
            </p>
            <p className="text-gray-600 text-xs">
              Built using AI • Powered by React & WebContainer
            </p>
          </div>
        </div>
      </div>
